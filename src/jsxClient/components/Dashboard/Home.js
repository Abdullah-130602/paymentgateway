...
const Home = () => {
  const RegTable = [
    ...
    //   name: "Murali Dharan",
    //   mobile: "+956 7894 3256",
    //   email: "cryptographic@gmail.com",
    //   action: 0,
    // },
    // {
    //   name: "Venkatesh waran",
    //   mobile: "+956 7894 3256",
    //   email: "cryptographic@gmail.com",
    //   action: 0,
    // },
    // {
    //   name: "Syed Ibrahim Khan",
    //   mobile: "+956 7894 3256",
    //   email: "cryptographic@gmail.com",
    //   action: 1,
    // },
  ...
  const ExClient = [
    ...
    // },
    // {
    //   name: "Mohammed Nathim",
    //   company: "MDS Solutions",
    //   mobile: "+956 7894 3256",
    //   subscription: 12,
    // },
    // {
        ...
        <div className="col-xl-12">
          <div className="row">
            ...
            <div className="flex gap-[17px] justify-end">
              <div className="p-2 rounded-[4px] bg-white mb-2 flex gap-2">
                {sortByTime.map((el, i) => {
                  return (
                    <button
                      className={`${
              ...
              <div className="p-2 rounded-[4px] bg-white mb-2">
                <DateRangePicker
                  initialSettings={{
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="card cardBG">
                    <div className="card-body tryal row py-14">
                      <div
                        style={{
                          display: "flex",
                        ...
                        <div className="card-body d-flex p-5 justify-content-between">
                          <div>
                            ...
                            <div className="d-flex align-items-center">
                              <h2 className="fs-32 font-w700 mb-0">342</h2>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="card">
                        <div className="card-body d-flex p-5 justify-content-between">
                          <div>
                            ...
                            <div className="d-flex align-items-center">
                              <h2 className="fs-32 font-w700 mb-0">971</h2>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="card">
                        <div className="card-body d-flex p-5 justify-content-between">
                          <div>
                            ...
                            <div className="d-flex align-items-center">
                              <h2 className="fs-32 font-w700 mb-0">857</h2>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="card">
                        <div className="card-body d-flex p-5 justify-content-between">
                          <div>
                            ...
                            <div className="d-flex align-items-center">
                              <h2 className="fs-32 font-w700 mb-0">15</h2>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div className="flex flex-col gap-3">
              {/* Buttons */}
              <div className="flex flex-col md:flex-col lg:flex-row gap-5 mt-4 md:mt-0 lg:mt-0">
                            ...
                            return (
                              <tr className="bg-white border-b" key={i}>
                                ...
                                >
                                  ...
                                  >
                                    <span>{el.email.slice(0, 20)}...</span>
                                  </OverlayTrigger>
                                </td>
                                <td className="px-3 py-2 text-[#545454]">
                                  {el.action === 1 ? (
                                    <div className="p-2 rounded-md bg-green-600 text-white text-center text-xs font-semibold">
                                      Sent
                                    </div>
                                  ) : (
                                    <button className="p-2 rounded-md bg-[#0aa1dd] text-white text-xs font-semibold">
                                      Send Form
                                    </button>
                                  )}
                                </td>
